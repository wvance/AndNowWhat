...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { end_date: @opportunity.end_date, opportunity_type: @opportunity.opportunity_type, opporunity_description: @opportunity.opporunity_description, start_date: @opportunity.start_date, status: @opportunity.status, title: @opportunity.title }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { end_date: @opportunity.end_date, opportunity_type: @opportunity.opportunity_type, opporunity_description: @opportunity.opporunity_description, start_date: @opportunity.start_date, status: @opportunity.status, title: @opportunity.title }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
